...
links:
  ...
  - name: Summary
    ...
    icon: file-invoice
  - name: Code
    url: "https://github.com/liyoumin/personalweb"
    icon_pack: fab
    icon: github
